...
const Section = ({id, bgOuter, bgInner, children}) => {
    ...
    <section className={`py-6 mb-40 sm:py-16 sm:mb-80 bg-${bgOuter ? bgOuter : 'white'}`} id={id ? `${id}`: undefined} >
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" preserveAspectRatio="none" className="waveTop absolute w-screen h-24 -mt-28 sm:h-36 sm:-mt-40 md:h-56 md:-mt-52">
        ...
        <div className={`container w-full sm:w-3/4 bg-${bgInner ? bgInner : 'none'} rounded-lg py-10 px-6  max-w-screen-xl space-y-16`}>
              {children}  
         </div>

         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" preserveAspectRatio="none" className="waveBottom absolute w-screen sm:h-32 sm:mt-12">
